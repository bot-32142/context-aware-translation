...
def test_begin_transaction(temp_term_repository: TermRepository):
    assert temp_term_repository._in_transaction is False
    temp_term_repository.begin_transaction()
    assert temp_term_repository._in_transaction is True
    temp_term_repository.commit_transaction()


def test_commit_transaction(temp_term_repository: TermRepository):
    temp_term_repository.begin_transaction()
    assert temp_term_repository._in_transaction is True
    temp_term_repository.commit_transaction()
    assert temp_term_repository._in_transaction is False
...
def test_rollback_transaction(temp_term_repository: TermRepository):
    temp_term_repository.begin_transaction()
    assert temp_term_repository._in_transaction is True
    temp_term_repository.rollback_transaction()
    assert temp_term_repository._in_transaction is False


def test_begin_transaction_raises_when_already_in_transaction(
    temp_term_repository: TermRepository,
):
    temp_term_repository.begin_transaction()
...
def test_begin_transaction_raises_when_closed(
    temp_term_repository: TermRepository,
):
    temp_term_repository.close()
    with pytest.raises(RuntimeError, match="StorageManager is closed"):
...
def test_commit_transaction_raises_when_closed(
    temp_term_repository: TermRepository,
):
    temp_term_repository.close()
    with pytest.raises(RuntimeError, match="StorageManager is closed"):
...
def test_apply_batch_respects_existing_transaction(
    temp_term_repository: TermRepository,
):
    temp_term_repository.begin_transaction()
