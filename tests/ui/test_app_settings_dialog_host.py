...
def test_app_settings_dialog_host_loads_qml_chrome_and_wraps_body_widget():
    ...
    try:
        ...
        assert root.objectName() == "appSettingsDialogChrome"
...
def test_app_settings_dialog_host_present_and_qml_close_update_dialog_state():
    host = AppSettingsDialogHost()
    try:
