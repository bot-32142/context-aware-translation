"""Worker for async glossary translation task run/cancel operations."""
...
class GlossaryTranslationTaskWorker(BaseWorker):
    """Worker to run/cancel persistent glossary translation tasks."""
