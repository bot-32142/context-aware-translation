"""Worker for async glossary review task run/cancel operations."""
...
class GlossaryReviewTaskWorker(BaseWorker):
    """Worker to run/cancel persistent glossary review tasks."""
