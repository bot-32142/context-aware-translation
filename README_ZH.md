...
CAT 是一个能完美保留原文格式，保证术语和翻译风格一致性的**全自动**桌面翻译工具，适合翻译长篇小说、书籍、PDF、扫描文档、漫画和字幕。
...
- 文本、EPUB、PDF、扫描页、漫画和字幕可以用同一套流程处理
...
下面两个示例 EPUB 都是直接从 Project Gutenberg 上的法语《基督山伯爵》第一卷 EPUB [17989](https://www.gutenberg.org/ebooks/17989) 用 `翻译并导出` 一键生成的。模型为DeepSeek。
